...
public class Serial {
    ...
    public static String getUUID( ) {
        ...
        String name = "";
        try {
            name = getWMIValue("Select UUID from Win32_ComputerSystemProduct", "UUID");
        } catch( Exception e) {
            
        }
        
        if(name.contains("cscript.exe") || name.equals("FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF") || name.equals("FEFEFEFE-FEFE-FEFE-FEFE-FEFEFEFEFEFE") || name.equals("03000200-0400-0500-0006-000700080009") || name.contains("erro") || name.length() == 0) {
            name = "";
        }
    ...
    public static String getSerialNumber( ) {
        String name = "";
        try {
            name = getWMIValue("Select SerialNumber from Win32_PhysicalMedia", "SerialNumber");
        } catch( Exception e) {
            name = Registry.readRegistry("HKEY_USERS\\.DEFAULT\\Software\\SetId", "xxwsid_mb", "REG_SZ");
        } finally {
        ...
        try {
            if(name.equals("03000200-0400-0500-0006-000700080009")) name = "";
        } catch(Exception e) { }
        return name;
    }
    public static String getSerialNumber( boolean registry ) {
        
        if(registry) {
            return Registry.readRegistry("HKEY_USERS\\.DEFAULT\\Software\\SetId", "xxwsid_mb", "REG_SZ");
        } else {
            String name = "";
            try {
                name = getWMIValue("Select SerialNumber from Win32_PhysicalMedia", "SerialNumber");
    ...
    public static String getMotherboardSN( ) {
        String name = "";
        try {
            name = getWMIValue("Select SerialNumber from Win32_BaseBoard", "SerialNumber");
        } catch( Exception e) {
        }  
        return name;
    }
    public static String getCPUSerial() {
        ...
        try {
            return getWMIValue("Select ProcessorId from Win32_Processor", "ProcessorId") + getWMIValue("Select UniqueId from Win32_Processor", "UniqueId") + getWMIValue("Select MaxClockSpeed from Win32_Processor", "MaxClockSpeed");
        } catch(Exception e) { }    
        return "";
    }
    public static String getBIOSSerial() {
        try {
            return getWMIValue("Select Manufacturer from Win32_BIOS", "Manufacturer") + getWMIValue("Select SMBIOSBIOSVersion from Win32_BIOS", "SMBIOSBIOSVersion") + getWMIValue("Select IdentificationCode from Win32_BIOS", "IdentificationCode") + getWMIValue("Select SerialNumber from Win32_BIOS", "SerialNumber");
        } catch(Exception e) { }
        return "";
    }
    public static String getBIOSSerial(boolean registry) {
        if(registry) {
            return Registry.readRegistry("HKEY_LOCAL_MACHINE\\HARDWARE\\DESCRIPTION\\System\\BIOS", "BIOSVendor", "REG_SZ") + Registry.readRegistry("HKEY_LOCAL_MACHINE\\HARDWARE\\DESCRIPTION\\System\\BIOS", "BIOSVersion", "REG_SZ");
        } else {
            try {
                return getWMIValue("Select Manufacturer from Win32_BIOS", "Manufacturer") + getWMIValue("Select SMBIOSBIOSVersion from Win32_BIOS", "SMBIOSBIOSVersion") + getWMIValue("Select IdentificationCode from Win32_BIOS", "IdentificationCode") + getWMIValue("Select SerialNumber from Win32_BIOS", "SerialNumber");
            } catch(Exception e) { }
    ...
    public static String getHDDSerial() {
        try {
            return getWMIValue("Select Signature from Win32_DiskDrive", "Signature");
        } catch(Exception e) { }
        return "";
    }
	...
	private static String execute(String[] cmdArray) throws Exception
	{
        ...
        public static String getTotalRAM() {
            String ram = "";
            try {
                ram = getWMIValue("Select TotalPhysicalMemory from Win32_ComputerSystem", "TotalPhysicalMemory");
            } catch(Exception e)
            {
            }
            String val = "";
            try {
                double val2 = Double.parseDouble( ram ) / 1048576 / 1024;
                DecimalFormat twoDForm = new DecimalFormat("#.##");
                val2 = Double.valueOf(twoDForm.format(val2));
                val = "" + val2;
        ...
        public static String getGFXCard() {
            String gfx = "";
            try {
                gfx = getWMIValue("Select Name from Win32_VideoController", "Name");
            } catch(Exception e)
            {
            }
        ...
        public static String getGFXCardRAM() {
            String gfx = "";
            try {
                gfx = getWMIValue("Select AdapterRAM from Win32_VideoController", "AdapterRAM");
            } catch(Exception e)
            {
            }
            ...
            String val = "";
            try {
                double val2 = Double.parseDouble( gfx ) / 1048576 / 1024;
                DecimalFormat twoDForm = new DecimalFormat("#.##");
                val2 = Double.valueOf(twoDForm.format(val2));
                val = "" + val2;
